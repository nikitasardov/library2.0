        ...
        <div class="default__container">
            ...
            <form method="post" action="index.php?action=edit&id=<?php echo $book['ID'];?>">
                <div class="input">
                    ...
                    echo get_book_authors($link, $book['ID']);
                    ?>" required>
                    <textarea class="input__description" name="description" placeholder="Фрагмент (по желанию)" autofocus required><?php
                    echo $book['BOOK_DESCRIPTION'];?></textarea>
                </div>
                ...
                <div class="default__buttonContainer">
                    ...
                    if(isset($_GET['admin'])) echo 'index.php';
                  else echo '../index.php';
                  ?>"><button type="button" class="default__button default__button--recomended">Отмена</button></a>
                </div>
			</form>
        </div>
    </body>
